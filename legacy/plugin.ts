...
// Interface definitions for DepTree-returning dependency analysis plugins for Vulnmap CLI.
...
export interface BaseInspectOptions {
  ...
  // supplied after "--" to the Vulnmap CLI.
...
export interface MultiSubprojectInspectOptions extends BaseInspectOptions {
  ...
  // NOTE: old versions of vulnmap-gradle-plugin have used `multiDepRoots`
  allSubProjects: true;
}
...
export interface MultiProjectResult {
  ...
  // NOTE: old versions of vulnmap-gradle-plugin have used `depRoots`
